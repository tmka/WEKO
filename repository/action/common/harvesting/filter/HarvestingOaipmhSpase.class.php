...
/**
 * Attribute ID for SPASE harvesting itemtype
 *
 * @package repository
 * @access  public
 */
 ...
 * @access  public
 */
class HarvestingOaipmhSpase extends RepositoryAction
{
    const SPASE_CATALOG_RESOURCEID = "ResourceID";
    const SPASE_CATALOG_RESOURCEHEADER_RESOURCENAME = "ResourceHeader.ResourceName";
    const SPASE_CATALOG_RESOURCEHEADER_RELEASEDATE = "ResourceHeader.ReleaseDate";
    const SPASE_CATALOG_RESOURCEHEADER_DESCRIPTION = "ResourceHeader.Description";
    const SPASE_CATALOG_RESOURCEHEADER_ACKNOWLEDGEMENT = "ResourceHeader.Acknowledgement";
    const SPASE_CATALOG_RESOURCEHEADER_CONTACT_PERSONID = "ResourceHeader.Contact.PersonID";
    const SPASE_CATALOG_RESOURCEHEADER_CONTACT_ROLE = "ResourceHeader.Contact.Role";
    const SPASE_CATALOG_ACCESSINFORMATION_REPOSITORYID = "AccessInformation.RepositoryID";
    const SPASE_CATALOG_ACCESSINFORMATION_AVAILABILITY = "AccessInformation.Availability";
    const SPASE_CATALOG_ACCESSINFORMATION_ACCESSRIGHTS = "AccessInformation.AccessRights";
    const SPASE_CATALOG_ACCESSINFORMATION_ACCESSURL_NAME = "AccessInformation.AccessURL.Name";
    const SPASE_CATALOG_ACCESSINFORMATION_ACCESSURL_URL = "AccessInformation.AccessURL.URL";
    const SPASE_CATALOG_ACCESSINFORMATION_ACCESSURL_DESCRIPTION = "AccessInformation.AccessURL.Description";
    const SPASE_CATALOG_ACCESSINFORMATION_FORMAT = "AccessInformation.Format";
    const SPASE_CATALOG_ACCESSINFORMATION_DATAEXTENT_QUANTITY = "AccessInformation.DataExtent.Quantity";
    const SPASE_CATALOG_PHENOMENONTYPE = "PhenomenonType";
    const SPASE_CATALOG_MEASUREMENTTYPE = "MeasurementType";
    const SPASE_CATALOG_TEMPORALDESCRIPTION_STARTDATE = "TemporalDescription.StartDate";
    const SPASE_CATALOG_TEMPORALDESCRIPTION_STOPDATE = "TemporalDescription.StopDate";
    const SPASE_CATALOG_TEMPORALDESCRIPTION_RELATIVESTOPDATE = "TemporalDescription.RelativeStopDate";
    const SPASE_CATALOG_OBSERVEDREGION = "ObservedRegion";
    const SPASE_CATALOG_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATESYSTEMNAME = "SpatialCoverage.CoordinateSystem.CoordinateSystemName";
    const SPASE_CATALOG_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATEREPRESENTATION = "SpatialCoverage.CoordinateSystem.CoordinateRepresentation";
    const SPASE_CATALOG_SPATIALCOVERAGE_NORTHERNMOSTLATITUDE = "SpatialCoverage.NorthernmostLatitude";
    const SPASE_CATALOG_SPATIALCOVERAGE_SOUTHERNMOSTLATITUDE = "SpatialCoverage.SouthernmostLatitude";
    const SPASE_CATALOG_SPATIALCOVERAGE_EASTERNMOSTLONGITUDE = "SpatialCoverage.EasternmostLongitude";
    const SPASE_CATALOG_SPATIALCOVERAGE_WESTERNMOSTLONGITUDE = "SpatialCoverage.esternmostLongitude";
    const SPASE_CATALOG_SPATIALCOVERAGE_UNIT = "SpatialCoverage.Unit";
    const SPASE_CATALOG_SPATIALCOVERAGE_MINIMUMALTITUDE = "SpatialCoverage.MinimumAltitude";
    const SPASE_CATALOG_SPATIALCOVERAGE_MAXIMUMALTITUDE = "SpatialCoverage.MaximumAltitude";
    const SPASE_CATALOG_SPATIALCOVERAGE_REFERENCE = "SpatialCoverage.Reference";
    const SPASE_CATALOG_PARAMETER_NAME = "Parameter.Name";
    const SPASE_CATALOG_PARAMETER_DESCRIPTION = "Parameter.Description";
    const SPASE_CATALOG_PARAMETER_FIELD_FIELDQUANTITY = "Parameter.Field.FieldQuantity";
    const SPASE_CATALOG_PARAMETER_PARTICLE_PARTICLETYPE = "Parameter.Particle.ParticleType";
    const SPASE_CATALOG_PARAMETER_PARTICLE_PARTICLEQUANTITY = "Parameter.Particle.ParticleQuantity";
    const SPASE_CATALOG_PARAMETER_WAVE_WAVETYPE = "Parameter.Parameter.Wave.WaveType";
    const SPASE_CATALOG_PARAMETER_WAVE_WAVEQUANTITY = "Parameter.Wave.WaveQuantity";
    const SPASE_CATALOG_PARAMETER_MIXED_MIXEDQUANTITY = "Parameter.Mixed.MixedQuantity";
    const SPASE_CATALOG_PARAMETER_SUPPORT_SUPPORTQUANTITY = "Parameter.Support.SupportQuantity";

    const SPASE_INSTRUMENT_RESOURCEID = "ResourceID";
    const SPASE_INSTRUMENT_RESOURCEHEADER_RESOURCENAME = "ResourceHeader.ResourceName";
    const SPASE_INSTRUMENT_RESOURCEHEADER_RELEASEDATE = "ResourceHeader.ReleaseData";
    const SPASE_INSTRUMENT_RESOURCEHEADER_DESCRIPTION = "ResourceHeader.Description";
    const SPASE_INSTRUMENT_RESOURCEHEADER_CONTACT_PERSONID = "ResourceHeader.Contact.PersonID";
    const SPASE_INSTRUMENT_RESOURCEHEADER_CONTACT_ROLE = "ResourceHeader.Contact.Role";
    //const SPASINSTRUMENT_I_TYPE = "Type";
    const SPASE_INSTRUMENT_INSTRUMENTTYPE = "InstrumentType";
    const SPASE_INSTRUMENT_INVESTIGATIONNAME = "InvestigationName";
    const SPASE_INSTRUMENT_OBSEVATORYID = "ObsevatoryID";

    const SPASE_OBSERVATORY_RESOURCEID = "ResourceID";
    const SPASE_OBSERVATORY_RESOURCEHEADER_RESOURCENAME = "ResourceHeader.ResourceName";
    const SPASE_OBSERVATORY_RESOURCEHEADER_RELEASEDATE = "ResourceHeader.ReleaseData";
    const SPASE_OBSERVATORY_RESOURCEHEADER_DESCRIPTION = "ResourceHeader.Description";
    const SPASE_OBSERVATORY_RESOURCEHEADER_CONTACT_PERSONID = "ResourceHeader.Contact.PersonID";
    const SPASE_OBSERVATORY_RESOURCEHEADER_CONTACT_ROLE = "ResourceHeader.Contact.Role";
    const SPASE_OBSERVATORY_LOCATION_OBSERVATORYREGION = "Location.ObservatoryRegion";
    const SPASE_OBSERVATORY_LOCATION_COORDINATESYSTEMNAME_LATITUDE = "Location.CoordinateSystemname.Latitude";
    const SPASE_OBSERVATORY_LOCATION_COORDINATESYSTEMNAME_LONGITUDE = "Location.CoordinateSystemname.Longitude";
    const SPASE_OBSERVATORY_OPERATINGSPAN_STARTDATE = "OperatingSpan.StartDate";

    const SPASE_PERSON_RESOURCEID = "ResourceID";
    const SPASE_PERSON_RELEASEDATE = "ReleaseDate";
    const SPASE_PERSON_PERSONNAME = "PersonName";
    const SPASE_PERSON_ORGANIZATIONNAME = "OrganizationName";
    const SPASE_PERSON_EMAIL = "Email";

    const SPASE_REPOSITORY_RESOURCEID = "ResourceID";
    const SPASE_REPOSITORY_RESOURCEHEADER_RESOURCENAME = "ResourceHeader.ResourceName";
    const SPASE_REPOSITORY_RESOURCEHEADER_RELEASEDATE = "ResourceHeader.ReleaseData";
    const SPASE_REPOSITORY_RESOURCEHEADER_DESCRIPTION = "ResourceHeader.Description";
    ...
    const SPASE_GRANULE_RELEASEDATE = "ReleaseData";
    const SPASE_GRANULE_PARENTID = "ParentID";
    const SPASE_GRANULE_STARTDATE = "StartDate";
    const SPASE_GRANULE_STOPDATE = "StopDate";
    const SPASE_GRANULE_SOURCE_SOURCETYPE = "Source.SourceType";
    const SPASE_GRANULE_SOURCE_URL = "Source.URL";
    const SPSAE_GRANULE_SOUCE_DATAEXTENT_QUANTITY = "Source.DataExtent.Quantity";
    const SPASE_GRANULE_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATESYSTEMNAME = "SpatialCoverage.CoordinateSystem.CoordinateSystemName";
    const SPASE_GRANULE_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATEREPRESENTATION = "SpatialCoverage.CoordinateSystem.CoordinateRepresentation";
    const SPASE_GRANULE_SPATIALCOVERAGE_NORTHERNMOSTLATITUDE = "SpatialCoverage.NorthernmostLatitude";
    const SPASE_GRANULE_SPATIALCOVERAGE_SOUTHERNMOSTLATITUDE = "SpatialCoverage.SouthernmostLatitude";
    const SPASE_GRANULE_SPATIALCOVERAGE_EASTERNMOSTLONGITUDE = "SpatialCoverage.EasternmostLongitude";
    const SPASE_GRANULE_SPATIALCOVERAGE_WESTERNMOSTLONGITUDE  = "SpatialCoverage.WesternmostLongitude";
    const SPASE_GRANULE_SPATIALCOVERAGE_UNIT = "SpatialCoverage.Unit";
    const SPASE_GRANULE_SPATIALCOVERAGE_MINIMUMALTITUDE = "SpatialCoverage.MinimumAltitude";
    const SPASE_GRANULE_SPATIALCOVERAGE_MAXIMUMALTITUDE = "SpatialCoverage.MaximumAltitude";
    const SPASE_GRANULE_SPATIALCOVERAGE_REFERENCE = "SpatialCoverage.Reference";

    /*
	const SPASE_CATALOG_RESOURCEID = "ResourceID";
	const SPASE_CATALOG_RESOURCEHEADER_RESOURCENAME = "ResourceName";
	const SPASE_CATALOG_RESOURCEHEADER_RELEASEDATA = "ReleaseData";
	const SPASE_CATALOG_RESOURCEHEADER_DESCRIPTION = "Description";
	const SPASE_CATALOG_RESOURCEHEADER_ACKNOWLEDGEMENT = "Acknowledgement";
	const SPASE_CATALOG_CONTACT_PERSONID = "PersonID";
	const SPASE_CATALOG_CONTACT_ROLE = "Role";
	const SPASE_CATALOG_ACCESSINFORMATION_REPOSITORYID = "RepositoryID";
	const SPASE_CATALOG_ACCESSINFORMATION_AVAILABILITY = "Availability";
	const SPASE_CATALOG_ACCESSINFORMATION_ACCESSRIGHTS = "AccessRights";
	const SPASE_CATALOG_ACCESSINFORMATION_ACCESSURL_NAME = "Name";
	const SPASE_CATALOG_ACCESSINFORMATION_ACCESSURL_URL = "URL";
	const SPASE_CATALOG_ACCESSINFORMATION_ACCESSURL_DESCRIPTION = "Description";
	const SPASE_CATALOG_ACCESSINFORMATION_FORMAT = "Format";
	const SPASE_CATALOG_PHENOMENONTYPE = "PhenomenonType";
	const SPASE_CATALOG_MEASUREMENTTYPE = "MeasurementType";
	const SPASE_CATALOG_TEMPORALDESCRIPTION_STARTDATE = "StartDate";
	const SPASE_CATALOG_TEMPORALDESCRIPTION_STOPDATE = "StopDate";
	const SPASE_CATALOG_TEMPORALDESCRIPTION_RELATIVESTOPDATE = "RelativeStopDate";
	const SPASE_CATALOG_OBSERVEDREGION = "ObservedRegion";
	const SPASE_CATALOG_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATESYSTEMNAME = "CoordinateSystemName";
	const SPASE_CATALOG_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATEREPRESENTATION = "CoordinateRepresentation";
	const SPASE_CATALOG_SPATIALCOVERAGE_NORTHERNMOSTLATITUDE = "NorthernmostLatitude";
	const SPASE_CATALOG_SPATIALCOVERAGE_SOUTHERNMOSTLATITUDE = "SouthernmostLatitude";
	const SPASE_CATALOG_SPATIALCOVERAGE_EASTERNMOSTLATITUDE = "EasternmostLatitude";
	const SPASE_CATALOG_SPATIALCOVERAGE_WESTERNMOSTLATITUDE = "WesternmostLatitude";
	const SPASE_CATALOG_SPATIALCOVERAGE_UNIT = "Unit";
	const SPASE_CATALOG_SPATIALCOVERAGE_MINIMUMALTITUDE = "MinimumAltitude";
	const SPASE_CATALOG_SPATIALCOVERAGE_MAXIMUMALTITUDE = "MaximumAltitude";
	const SPASE_CATALOG_SPATIALCOVERAGE_REFERENCE = "Reference";
	const SPASE_CATALOG_PARAMETER_NAME = "Name";
	const SPASE_CATALOG_PARAMETER_DESCRIPTION = "Description";
	const SPASE_CATALOG_PARAMETER_FIELD_FIELDQUANTITY = "FieldQuantity";
	const SPASE_CATALOG_PARAMETER_PARTICLE_PARTICLETYPE = "ParticleType";
	const SPASE_CATALOG_PARAMETER_PARTICLE_PARTICLEQUANTITY = "ParticleQuantity";
	const SPASE_CATALOG_PARAMETER_WAVE_WAVETYPE = "WaveType";
	const SPASE_CATALOG_PARAMETER_WAVE_WAVEQUANTITY = "WaveQuantity";
	const SPASE_CATALOG_PARAMETER_MIXED_MIXEDQUANTITY = "MixedQuantity";
	const SPASE_CATALOG_PARAMETER_SUPPORT_SUPPORTQUANTITY = "SupportQuantity";
	
	// SPASE_INSTRUMENT
	const SPASE_INSTRUMENT_RESOURCEID = "ResourceID";
	const SPASE_INSTRUMENT_RESOURCEHEADER_RESOURCENAME = "ResourceName";
	const SPASE_INSTRUMENT_RESOURCEHEADER_RELEASEDATA = "ReleaseData";
	const SPASE_INSTRUMENT_RESOURCEHEADER_DESCRIPTION = "Description";
	const SPASE_INSTRUMENT_RESOURCEHEADER_CONTACT_PERSONID = "PersonID";
	const SPASE_INSTRUMENT_RESOURCEHEADER_CONTACT_ROLE = "Role";
	const SPASE_INSTRUMENT_INSTRUMENTTYPE = "InstrumentType";
	const SPASE_INSTRUMENT_INVESTIGATIONNAME = "InvestigationName";
	const SPASE_INSTRUMENT_OBSEVATORYID = "ObsevatoryID";
	...
	// SPASE_OBSERVATORY
	const SPASE_OBSERVATORY_RESOURCEID = "ResourceID";
	const SPASE_OBSERVATORY_RESOURCEHEADER_RESOURCENAME = "ResourceName";
	const SPASE_OBSERVATORY_RESOURCEHEADER_RELEASEDATA = "ReleaseData";
	const SPASE_OBSERVATORY_RESOURCEHEADER_DESCRIPTION = "Description";
	const SPASE_OBSERVATORY_RESOURCEHEADER_CONTACT_PERSONID = "PersonID";
	const SPASE_OBSERVATORY_RESOURCEHEADER_CONTACT_ROLE = "Role";
	const SPASE_OBSERVATORY_LOCATION_OBSERVATORYREGION = "ObservatoryRegion";
	const SPASE_OBSERVATORY_LOCATION_COORDINATESYSTEMNAME_LATITUDE = "Latitude";
	const SPASE_OBSERVATORY_LOCATION_COORDINATESYSTEMNAME_LONGITUDE = "Longitude";
	...
	// SPASE_REPOSITORY
	const SPASE_REPOSITORY_RESOURCEID = "ResourceID";
	const SPASE_REPOSITORY_RESOURCEHEADER_RESOURCENAME = "ResourceName";
	const SPASE_REPOSITORY_RESOURCEHEADER_RELEASEDATA = "ReleaseData";
	const SPASE_REPOSITORY_RESOURCEHEADER_DESCRIPTION = "Description";
	const SPASE_REPOSITORY_RESOURCEHEADER_CONTACT_PERSONID = "PersonID";
	const SPASE_REPOSITORY_RESOURCEHEADER_CONTACT_ROLE = "Role";
	const SPASE_REPOSITORY_ACCESSURL_URL = "URL";
	
	// SPASE_GRANULE
	const SPASE_GRANULE_RESOURCEID = "ResourceID";
	const SPASE_GRANULE_RELEASEDATA = "ReleaseData";
	const SPASE_GRANULE_PARENTID = "ParentID";
	const SPASE_GRANULE_STARTDATE = "StartDate";
	const SPASE_GRANULE_STOPDATE = "StopDate";
	const SPASE_GRANULE_SOURCE_SOURCETYPE = "SourceType";
	const SPASE_GRANULE_SOURCE_URL = "URL";
	const SPASE_GRANULE_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATESYSTEMNAME = "CoordinateSystemName";
	const SPASE_GRANULE_SPATIALCOVERAGE_COORDINATESYSTEM_COORDINATEREPRESENTATION = "CoordinateRepresentation";
	const SPASE_GRANULE_SPATIALCOVERAGE_NORTHERNMOSTLATITUDE = "NorthernmostLatitude";
	const SPASE_GRANULE_SPATIALCOVERAGE_SOUTHERNMOSTLATITUTE = "SouthernmostLatitute";
	const SPASE_GRANULE_SPATIALCOVERAGE_EASTERNMOSTLONGITUDE = "EasternmostLongitude";
	const SPASE_GRANULE_SPATIALCOVERAGE_WESTERNMOSTLONGTITUDE = "WesternmostLongtitude";
	const SPASE_GRANULE_SPATIALCOVERAGE_UNIT = "Unit";
	const SPASE_GRANULE_SPATIALCOVERAGE_MINIMUMALTITUDE = "MinimumAltitude";
	const SPASE_GRANULE_SPATIALCOVERAGE_MAXIMUMALTITUDE = "MaximumAltitude";
	const SPASE_GRANULE_SPATIALCOVERAGE_REFERENCE = "Reference";
    */
     ...
     */
    public function HarvestingOaipmhSpase($Session, $Db){
