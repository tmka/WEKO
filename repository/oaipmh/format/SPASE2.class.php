...
class Repository_Oaipmh_Spase2 extends Repository_Oaipmh_FormatAbstract
{
    /*
     * 各タグ変数
     */
    ...
    private function outputHeader()
    {
        ...
        $domElement = $this->domDocument->createElementNS(RepositoryConst::SPASE_SCHEMA_ORG, RepositoryConst::LIDO_TAG_LIDO_WRAP);
        ...
        $domElement->setAttribute('xmlns:xsi', RepositoryConst::SPASE_SCHEMA_XSD);
        // add attribute xsi:schemaLocation="http://www.lido-schema.org http://www.lido-schema.org/schema/v1.0/lido-v1.0.xsd"
        $domElement->setAttribute('xsi:schemaLocation', RepositoryConst::SPASE_SCHEMA_ORG.' '.RepositoryConst::LIDO_SCHEMA_XSD.' '.RepositoryConst::GML_SCHEMA.' '.RepositoryConst::GML_SCHEMA_XSD);
        
        // add DOM Element to member DOM Document
        $this->domDocument->appendChild($domElement);
        
        // add element <lido:lido>
        $lidoTagElement = $this->domDocument->createElement('SPASE.');
    ...
    private function outputMetadata($itemData, $domElement)
    {
        ...
        {
            $this->item_language = RepositoryConst::SPASE_LANG_JAPANESE;
        }
