...
class Repository_Oaipmh_Spase3 extends Repository_Oaipmh_FormatAbstract
{
    /*
     * 各タグ変数
     */
    ...
    // const xml value
    const SPASE_VALUE_SOURCE = 'SPASEv2.2.3';
        ...
        for($ii=0; $ii<count($metadata_item); $ii++){
            ...
            switch($spaseMap)
            {
                ...
                case RepositoryConst::SPASE_CATALOG_RESOURCEHEADER_RESOURCENAME:
                    //$this->catalog->addResourceheader_Resourcename($value);
                    break;
        ...
        for($ii=0; $ii<count($metadata_item); $ii++){
            ...
            switch($spaseMap)
            {
                ...
                case RepositoryConst::SPASE_INSTRUMENT_RESOURCEHEADER_RESOURCENAME:
                    //$this->instrument->addResourceheader_Resourcename($value);
                    break;
        ...
        for($ii=0; $ii<count($metadata_item); $ii++){
            ...
            switch($spaseMap)
            {
                ...
                case RepositoryConst::SPASE_OBSERVATORY_RESOURCEHEADER_RESOURCENAME:
                    //$this->observatory->addResourceheader_Resourcename($value);
                    break;
        ...
        for($ii=0; $ii<count($metadata_item); $ii++){
            ...
            switch($spaseMap)
            {
                ...
                case RepositoryConst::SPASE_REPOSITORY_RESOURCEHEADER_RESOURCENAME:
                    //$this->repository->addResourceheader_Resourcename($value);
                    break;
  ...
  */
  ...
  public function addResourceheader_Contact_Role(Repository_Oaipmh_SPASE_LangString $Resourceheader_Contact_Role){
    if($this->Resourceheader_Contact_Role == null){
        $this->Resourceheader_Contact_Role = $Resourceheader_Contact_Role;
    }
  }
...
class Repository_Oaipmh_SPASE_Array{
     ...
     * addTaxon
     */
    public function addTaxon(Repository_Oaipmh_SPASE_Array $ar){
