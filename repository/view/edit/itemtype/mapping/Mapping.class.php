...
//  var $junii2ChildArray = null;		// 3.JuNii2(子)=>廃止
    ...
    private function setSpase(&$spaseCandidateArray)
    {
    	$spaseCandidateArray = array(
    			...
    			array('displayName' => RepositoryConst::SPASE_CATALOG_CONTACT_PERSONID, 'selectFlag' => 'true'),
    			array('displayName' => RepositoryConst::SPASE_CATALOG_CONTACT_ROLE, 'selectFlag' => 'true'),
    			...
    			array('displayName' => RepositoryConst::SPASE_INSTRUMENT_RESOURCEHEADER_RELEASEDATA, 'selectFlag' => 'true'),
    			...
    			array('displayName' => RepositoryConst::SPASE_OBSERVATORY_RESOURCEHEADER_RELEASEDATA, 'selectFlag' => 'true'),
    			...
    			array('displayName' => RepositoryConst::SPASE_REPOSITORY_RESOURCEHEADER_RELEASEDATA, 'selectFlag' => 'true'),
    			...
    			array('displayName' => RepositoryConst::SPASE_GRANULE_RELEASEDATA, 'selectFlag' => 'true'),
